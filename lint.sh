...
OPTION="--recursive"
SRC_DIR="src/"
FILTER="-'build/include',-whitespace/braces,-whitespace/line_length,-build/c++11,-whitespace/indent,-whitespace/parens,-build/include_subdir,+build/include_what_you_use,-runtime/indentation_namespace"
TMP=.tmp
